package com.gm.blackkite.helper;
...
public class Constant {
    ...
    public static final String DEF_PINCODEID = "1";
    public static final String DEF_PINCODENAME = "500062";
    ...
    public static final String PINCODE_TEXT = "pincode_text";
