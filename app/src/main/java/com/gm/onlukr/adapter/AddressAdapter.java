...
import com.gm.onlukr.activity.MainActivity;
import com.gm.onlukr.fragment.AddressAddUpdateFragment;
...
import com.gm.onlukr.model.Address;
...
public class AddressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holderParent, final int position) {
        ...
        if (Constant.selectedAddressId.equals(id)) {
            AddressListFragment.selectedAddress = address.getAddress() + ", " + address.getLandmark() + ", " + address.getCity_text() + ", " + address.getArea_text() + ", " + address.getState() + ", " + address.getCountry() + ", " + activity.getString(R.string.pincode_) + address.getPincode_text();
        ...
        holder.tvAddress.setText(address.getAddress() + ", " + address.getLandmark() + ", " + address.getCity_text() + ", " + address.getArea_text() + ", " + address.getState() + ", " + address.getCountry() + ", " + activity.getString(R.string.pincode_) + address.getPincode_text());
        Constant.DefaultPinCode = address.getPincode();
        Constant.DefaultCity = address.getCity();
